...
use crate::{block::Block, transaction::{TXOutput, Transaction}};
...
impl Blockchain{
    pub fn new() -> Result<Blockchain>{
        ...
        let hash = db.get("LAST")?.expect("Must crrate a new block database first");
    ...
    pub fn find_spendable_outputs(
        ...
        /* `(i32, HashMap<std::string::String, Vec<i32>>)` value */
        return (accumulated, unspent_outputs);
    }
}
